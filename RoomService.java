...
public class RoomService {
    ...
    // Changed on 28/04 at 11:04 AM: added ZEGOCLOUD configuration fields for backend video-call session generation
    ...
    public Room createRoom(Room room, User currentUser) {
        ...
        // Changed on 28/04 at 10:18 AM: make the room creator the first member of every new room
    ...
    // Changed on 28/04 at 10:58 AM: restrict room-member add flow to managers and team leaders only
    public List<User> addMemberByStaffId(Long roomId, String staffId, User currentUser) {
        ...
        if (currentUser.getRole().equals("DEVELOPER")) {
            throw new RuntimeException("Developers are not allowed to add room members");
        }
    ...
    // Changed on 28/04 at 11:10 AM: restrict room-member remove flow to managers and team leaders only
    public List<User> removeMember(Long roomId, Long memberId, User currentUser) {
        ...
        if (currentUser.getRole().equals("DEVELOPER")) {
            throw new RuntimeException("Developers are not allowed to remove room members");
        }
    ...
    // Changed on 28/04 at 11:20 AM: generate secure ZEGOCLOUD room-call session data only for room members
